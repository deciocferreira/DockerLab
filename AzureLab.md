...
Neste exemplo, iremos fazer o deploy da aplicação do Prometheus, através do serviço *App Service* no Azure. Com isso, temos ganho de tempo nas implantações, portabilidade e escalabilidade, além de reduzir custos de infraestrutura. 
...
## 2. Upload do projeto para dentro do DockerHub

Com uma conta no DockerHub previamente criada, faça o upload da imagem anterior para o repositório:
